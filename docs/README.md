...
## 빠른 시작
- **Home Assistant 연동 설정**: [config-schema/common-entity-options.md](./config-schema/common-entity-options.md#home-assistant-연동-설정) – MQTT Discovery와 영역/디바이스 매핑 가이드.
