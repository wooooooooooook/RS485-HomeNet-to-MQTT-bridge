...
describe('Checksum Verification', () => {
    it('should verify checksums for user packets', () => {
        ...
        for (const packet of packets) {
            ...
            console.log(`Packet: ${packet.map(b => b.toString(16).padStart(2, '0')).join(' ')} - Calculated: 0x${sum.toString(16).padStart(2, '0')}, Expected: 0x${expectedChecksum.toString(16).padStart(2, '0')}, Valid: ${sum === expectedChecksum}`);
